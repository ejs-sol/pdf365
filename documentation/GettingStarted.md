...
1. Lock down inbound traffic to trusted IP ranges.
2. Put the API behind your gateway (rate limits, auth, logging).
3. Enforce HTTPS/TLS end-to-end.
4. Rotate VM image and OS patches regularly.
5. Monitor request volume and error rates.
